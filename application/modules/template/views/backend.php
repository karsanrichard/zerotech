...
<body>
    <div id="wrapper">
        <?php 
            echo $this->load->view('admin_navbar');
        ?>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">ZEROTECH SHOP ADMIN</span>
                </li>
                <li class="dropdown">
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?php echo ASSETS_URL;?>backend/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?php echo ASSETS_URL;?>backend/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?php echo ASSETS_URL;?>backend/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?php echo ASSETS_URL;?>backend/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?php echo ASSETS_URL;?>backend/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?php echo ASSETS_URL;?>backend/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
    ...
    <!-- Flot -->
    <script src="<?php echo ASSETS_URL;?>backend/js/plugins/flot/jquery.flot.js"></script>
    <script src="<?php echo ASSETS_URL;?>backend/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="<?php echo ASSETS_URL;?>backend/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="<?php echo ASSETS_URL;?>backend/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="<?php echo ASSETS_URL;?>backend/js/plugins/flot/jquery.flot.pie.js"></script>
...
<script src="<?php echo ASSETS_URL;?>backend/js/plugins/dropzone/dropzone.js"></script>
    ...
    <script>
        $(document).ready(function() {
            ...
            //         timeOut: 4000
            //     };
            //     toastr.success('Welcome to ZEROTECH');
