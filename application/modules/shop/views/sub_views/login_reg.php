					...
					<div class="row">
						<div class="col-sm-6">
							<div class="box-border">
								...
								<p>
									<button class="button" id = "create_account"><i class="fa fa-user"></i> Create an account</button>
								</p>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="box-border">
								...
								<form method = "POST" action = "<?php echo base_url(); ?>shop/authenticate">
									<p>
...
<script type="text/javascript">
	$('#create_account').click(function(){
		window.location.assign("<?php echo base_url(); ?>shop/registration");
	});
</script>